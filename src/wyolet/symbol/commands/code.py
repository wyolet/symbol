"""`symbol code` — retrieve the body at a known address."""
...
from wyolet.symbol.caches import build_read_cache, record_served
from wyolet.symbol.reads.code import CodeAmbiguous, CodeNotFound, code as code_query
...
def code_cmd(
    ...
    try:
        ...
        if format == "json":
            ...
            console.print("[dim]Try: symbol search <name>[/dim]")
        return

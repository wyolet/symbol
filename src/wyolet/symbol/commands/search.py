"""`symbol search` — narrow candidates by name, return signatures + previews."""
...
from wyolet.symbol.reads.search import search as search_query
...
def search_cmd(
    ...
    console.print(f"\n[dim]Use[/dim] [bold]symbol code <file:start-end>[/bold] [dim]to fetch a body.[/dim]")

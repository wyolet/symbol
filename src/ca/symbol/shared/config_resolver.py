...
from ca.symbol.shared.context import ActiveFramework, ResolvedConfig
...
def resolve_config(
    ...
    #   4. project [tool.symbol.side_effects] (wins last — full override)
    ...
    # --- severity overrides and ignore patterns from [tool.symbol.checkers.NAME] ---

...
from ca.symbol.shared.project_config import ProjectConfig
...
def build_context(
    ...
    """
    from ca.symbol.shared.deps import detect_deps
    from ca.symbol.shared.config_resolver import resolve_config
    from ca.symbol.shared.framework_detector import detect_active_frameworks
    from ca.symbol.shared.project_config import load_project_config
    from ca.symbol.shared.registry import load_custom_checkers

...
def map_cmd(
    ...
    console.print()
    console.print(Panel(Text(f"{I1}ca map — {project_name}/", style="bold"), style="dim", expand=False))
...
def _run_blast(
    ...
    console.print()
    console.print(Panel(Text(f"{I1}ca map --blast — {project_name}/", style="bold"), style="dim", expand=False))
    console.print()
